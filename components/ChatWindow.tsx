...
export function ChatWindow(props: {
          ...
          <ul>
            ...
            <li className="p-3">
              {(showDocEmbedForm || showIngestForm || showSearchForm) && (
                <Tooltip
                  content="Upload a Webpage Content"
            ...
            <li className="p-3">
              {(showDocEmbedForm || showIngestForm || showUrlEntryForm) && (
                <Tooltip
                  content="Upload Web Search Result"
                  className="inline-flex"
                >
                  <button
                    className="inline-flex bg-kaito-brand-ash-green hover:bg-kaito-brand-ash-green items-center font-medium text-gray-200 rounded-full px-5 py-5"
  ...
  return (
    <div className={` text-black ${readyToChat ? "border" : ""}`}>
      <h2
        className={`${
          readyToChat ? "" : "hidden"
      ...
      {readyToChat ? (
        <div className="flex flex-col p-4 md:p-8 grow overflow-hidden">
