...
export function TextUploadForm(props: {
  ...
  return (
    <>
      ...
      >
        <textarea
          className="w-full px-2 py-2 text-sm bg-white border-x-0 border-t-0 border-b border-gray-200 rounded-t-lg focus:ring-0 focus:ring-inset focus:ring-kaito-brand-ash-green"
          id="raw-text-injest"
          value={document}
          rows={14}
        ...
        <div className="inline-flex justify-end mt-2 space-x-6 items-center px-3 py-2 ">
          <Tooltip content="Ingest" className="inline-flex">
            <button
              type="submit"
              className="flex px-5 py-4 bg-kaito-brand-ash-green text-gray-200 rounded-full  max-w-24 max-h-24 items-center shrink-0 "
            >
              <div
                role="status"
