    ...
    <>
        <div className="p-4 md:p-8 rounded bg-[#25252d] w-full max-h-[85%] overflow-hidden flex flex-col">
            ...
            <h3 className="text-xl mb-4 ml-auto mr-auto">
                <a target="_blank" href="https://github.com/tantaraio/voy" rel="noreferrer">
                🦀 Voy
                </a>{" "}
                +{" "}
                <a target="_blank" href="https://ollama.ai/" rel="noreferrer">
                🦙 Ollama
                </a>{" "}
                +{" "}
                <a target="_blank" href="https://js.langchain.com" rel="noreferrer">
                🦜🔗 LangChain.js
                </a>{" "}
                +{" "}
                <a
                target="_blank"
                href="https://huggingface.co/docs/transformers.js/index" rel="noreferrer"
                >
                🤗 Transformers.js
                </a>
            </h3>
            <ul>
                <li className="text-l">
                    🏡
                    <span className="ml-2">
                        Yes, it&apos;s another chat over documents implementation... but
                        this one is entirely local!
                    </span>
                </li>
                ...
                <li>
                    ⚙️
                    <span className="ml-2">
                        The default LLM is Llama 2 run locally by Ollama. You&apos;ll need
                        to install{" "}
                        <a target="_blank" href="https://ollama.ai" rel="noreferrer">
                ...
                <li className="text-l">
                    👇
                    <span className="ml-2">
                        Try embedding a PDF below, then asking questions! You can even
                        turn off your WiFi.
                    </span>
                </li>
            </ul>
