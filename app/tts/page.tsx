...
export default function TTSPage() {
	...
	return (
		<div className="container mx-auto p-4 max-w-2xl h-screen">
			...
			<p className="text-kaito-brand-ash-green text-lg text-center mb-4">
				Type in your text. Click Convert. Audio appears below.
				{/* You can ask follow up questions. */}
			</p>

			<Card className="border-b-kaito-brand-ash-green border-x-kaito-brand-ash-green bg-gray-50  rounded-lg shadow-lg">
				<Textarea
				...
				<div className="flex justify-end gap-4 ">
					<Button
						...
						className="text-gray-200 bg-kaito-brand-ash-green hover:bg-kaito-brand-ash-green py-5 px-5  mr-4 mb-4"
					>
